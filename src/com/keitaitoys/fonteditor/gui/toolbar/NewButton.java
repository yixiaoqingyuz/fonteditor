...
public class NewButton extends JButton implements LocaleChangeListener, ActionListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "toolbar.button.new.caption";
	private static final String TOOLTIP_LOCALIZE_KEY = "toolbar.button.new.tooltip";
	...
	public NewButton() {
		...
		manager.registerNewButton(this);
	...
	private void init() {
		...
		URL url = getClass().getResource("img/iconnew.png");
