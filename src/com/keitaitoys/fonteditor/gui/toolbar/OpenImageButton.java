...
public class OpenImageButton extends JButton implements LocaleChangeListener, ActionListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "toolbar.button.openimage.caption";
	private static final String TOOLTIP_LOCALIZE_KEY = "toolbar.button.openimage.tooltip";
	...
	public OpenImageButton() {
		...
		manager.registerOpenImageButton(this);
	...
	private void init() {
		...
		URL url = getClass().getResource("img/iconopenimage.png");
