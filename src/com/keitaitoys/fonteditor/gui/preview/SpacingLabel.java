...
public class SpacingLabel extends JLabel implements LocaleChangeListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "preview.label.spacing.caption";
	...
	private void init() {
		...
		setDisplayedMnemonic(KeyEvent.VK_P);
