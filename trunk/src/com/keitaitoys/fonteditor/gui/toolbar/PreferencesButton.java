...
public class PreferencesButton extends JButton implements LocaleChangeListener, ActionListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "toolbar.button.preferences.caption";
	private static final String TOOLTIP_LOCALIZE_KEY = "toolbar.button.preferences.tooltip";
	...
	public PreferencesButton() {
		...
		manager.registerPreferencesButton(this);
	...
	private void init() {
		...
		URL url = getClass().getResource("img/iconpreferences.png");
