...
public class OptionsMenu extends JMenu implements LocaleChangeListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "menu.options.caption";
	...
	public OptionsMenu() {
		...
		manager.registerOptionsMenu(this);
