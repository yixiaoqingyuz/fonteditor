...
public class PreferencesOKButton extends JButton implements LocaleChangeListener, ActionListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "preferences.button.ok.caption";
	...
	public PreferencesOKButton() {
		
		Manager manager = Manager.getInstance();
		manager.registerPreferencesOKButton(this);
