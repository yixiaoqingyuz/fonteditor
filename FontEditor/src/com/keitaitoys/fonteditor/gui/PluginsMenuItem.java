...
public class PluginsMenuItem extends JMenuItem implements LocaleChangeListener, ActionListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "menuitem.plugins.caption";
	...
	public PluginsMenuItem() {
		...
		manager.registerPluginsMenuItem(this);
