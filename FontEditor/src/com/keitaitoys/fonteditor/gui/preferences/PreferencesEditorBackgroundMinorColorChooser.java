...
public class PreferencesEditorBackgroundMinorColorChooser extends JColorChooser implements LocaleChangeListener, ActionListener {
	...
	private static final String TITLE_LOCALIZE_KEY = "preferences.editor.colorchooser.background.minor.title";
	...
	public PreferencesEditorBackgroundMinorColorChooser() {
		
		Manager manager = Manager.getInstance();
		manager.registerPreferencesEditorBackgroundMinorColorChooser(this);
