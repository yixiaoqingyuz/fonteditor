...
public class PreferencesPreviewBackgroundColorChooser extends JColorChooser implements LocaleChangeListener, ActionListener {
	...
	private static final String TITLE_LOCALIZE_KEY = "preferences.preview.colorchooser.background.title";
	...
	public PreferencesPreviewBackgroundColorChooser() {
		
		Manager manager = Manager.getInstance();
		manager.registerPreferencesPreviewBackgroundColorChooser(this);
	...
	private void init() {
		...
		setColor(preferencesManager.getPreviewBackgroundColor());
