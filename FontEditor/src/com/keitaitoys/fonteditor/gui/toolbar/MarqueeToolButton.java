...
public class MarqueeToolButton extends JButton implements LocaleChangeListener, ActionListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "toolbar.button.marqueetool.caption";
	private static final String TOOLTIP_LOCALIZE_KEY = "toolbar.button.marqueetool.tooltip";
	...
	public MarqueeToolButton() {
		
		Manager manager = Manager.getInstance();
		manager.registerMarqueeToolButton(this);
	...
	private void init() {
		...
		URL url = getClass().getResource("img/iconmarqueetool.png");
