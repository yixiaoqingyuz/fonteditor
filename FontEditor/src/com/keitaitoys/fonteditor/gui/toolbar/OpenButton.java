...
public class OpenButton extends JButton implements LocaleChangeListener, ActionListener {
	...
	private static final String CAPTION_LOCALIZE_KEY = "toolbar.button.open.caption";
	private static final String TOOLTIP_LOCALIZE_KEY = "toolbar.button.open.tooltip";
	...
	public OpenButton() {
		...
		manager.registerOpenButton(this);
	...
	private void init() {
		...
		URL url = getClass().getResource("img/iconopen.png");
